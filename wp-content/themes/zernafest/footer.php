  ...
  <div class="footer__row-up">
    <div class="footer__content">
      ...
      <div class="footer__row-down">
        ...
        <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAnmzO_QZ24TTTCGhY-DWz-ZBh8HBe4YA4&amp;callback=initMap"></script>
        <script src="plugins/modal-video/jquery-modal-video.js?v=1."></script>
        <script src="plugins/slick/slick.min.js?v=1."></script>
        <script src="plugins/input_mask/jquery.maskedinput.min.js?v=1."></script>
